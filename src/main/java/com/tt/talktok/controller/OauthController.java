...
//        student.setStu_no(userProfileMap.get("id").toString());
        student.setStu_nickname(((Map<String, Object>) userProfileMap.get("properties")).get("nickname").toString());
        student.setStu_email(((Map<String, Object>) userProfileMap.get("kakao_account")).get("email").toString());
        student.setStu_pwd(UUID.randomUUID().toString()); // 비밀번호는 임의로 생성

        session.setAttribute("student", student);
        model.addAttribute("email", student.getStu_email());
        model.addAttribute("nickname", student.getStu_nickname());
        return "myPage";
    }
...
//        String[] emailParts=fullEmail.split("@");
        ...
        student.setStu_nickname(nickname);
        student.setStu_email(fullEmail);
        student.setStu_phone(phone);
        student.setStu_pwd(pwd);
